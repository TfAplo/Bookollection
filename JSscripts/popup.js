...
const categoryButtons = document.querySelectorAll('button[data-category]');
            ...
            categoryButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    if (category === 'profil') {
                        popup.innerHTML = '<span class="close" id="closeButton">&times;</span><img alt="img_compte" id="img_popup" src="images/account_circle_clair-removebg-preview.png"><p>Nom d\'utilisateur: Sebastien Bernard </p><p>Mot de passe: *****************</p><p>Email: sebastien.bernard@gmail.com</p><p>Date de naissance: 19/06/1975</p>';
